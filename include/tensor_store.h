 ...
 */
void get_physical_offset(int rank, const hsize_t *tile_coords, const hsize_t *chunk_dims, hsize_t *phys_offset_out);
 ...
 */
herr_t read_chunk_fast(hid_t dset_id, const hsize_t *phys_offset, double *data_ptr, int rank, const hsize_t *chunk_dims);
 ...
 * chunk_dims: Size of each chunk dimension
 */
herr_t write_chunk_fast(hid_t dset_id, const hsize_t *phys_offset, const double *data_ptr, int rank, const hsize_t *chunk_dims);
